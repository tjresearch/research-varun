...
def main():
    text_header = (u"Welcome to the urwid tour!  "
        u"UP / DOWN / PAGE UP / PAGE DOWN scroll.  F8 is the EMRGENCY EXIT (DONT USE UNLESS BACKED UP) exits.")
    text_button_list = [u"Backups", u"Exceptions", u"Active Threads", u"Close" , u"Help"]
